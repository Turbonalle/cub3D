...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/15 14:27:12 by slampine          #+#    #+#             */
/*   Updated: 2023/11/16 14:10:26 by slampine         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_minimap_player(cub3d_t *cub3d)
{
	...
	draw_square(cub3d, (int)column, (int)row,
		size, cub3d->minimap.color_player);
}
...
void	draw_minimap_playerdir(cub3d_t *cub3d)
{
	...
	end.x = cub3d->minimap.player_pos.x
		+ (cub3d->player.dir.x * cub3d->minimap.tile_size / 2);
	end.y = cub3d->minimap.player_pos.y
		+ (cub3d->player.dir.y * cub3d->minimap.tile_size / 2);
	draw_line(cub3d->minimap.img, cub3d->minimap.player_pos,
		end, cub3d->minimap.color_playerdir);
}
