...
# define MINIMAP_COLOR_PLAYER YELLOW_PALE
# define MINIMAP_COLOR_PLAYERDIR WHITE
# define MINIMAP_COLOR_FOV BURGUNDY_DARK
# define MINIMAP_COLOR_EMPTY GRAY_DARK
# define MINIMAP_COLOR_FLOOR BLACK
# define MINIMAP_COLOR_WALL GRAY_DARK
# define MINIMAP_COLOR_ENEMY GREEN_DARK
# define MINIMAP_COLOR_KEY_1 RED
# define MINIMAP_COLOR_KEY_2 GREEN_BRIGHT
# define MINIMAP_COLOR_KEY_3 ORANGE_LIGHT
