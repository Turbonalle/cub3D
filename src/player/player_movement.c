...
void player_rotation(cub3d_t *cub3d)
{
	...
	{
		cub3d->player.angle -= ROTATION_SPEED * cub3d->frame_time;
...
void player_walking(cub3d_t *cub3d)
{
	if (cub3d->keys.w && !cub3d->keys.s)
	{
		...
		cub3d->player.new_pos.x += cos(cub3d->player.angle) * MOVEMENT_SPEED * cub3d->frame_time;
		cub3d->player.new_pos.y += sin(cub3d->player.angle) * MOVEMENT_SPEED * cub3d->frame_time;
	}
...
void player_strafing(cub3d_t *cub3d)
{
	if (cub3d->keys.a && !cub3d->keys.d)
	{
		...
		cub3d->player.new_pos.x += cos(cub3d->player.movement_angle) * MOVEMENT_SPEED * cub3d->frame_time;
		cub3d->player.new_pos.y += sin(cub3d->player.movement_angle) * MOVEMENT_SPEED * cub3d->frame_time;
	}
